    ...
    useEffect(() => {
        ...
        const calendar = new Calendar(calendarRef.current, {
            ...
            eventClick: function (info) {
                ...
                let detailsHtml = `
          <strong>Tipo:</strong> ${props.type === "despesa" ? "Despesa" : "Receita"}<br>
        ...
        `;
            ...
            eventDidMount: function (info) {
                ...
                const tooltip = `${props.type === "despesa" ? "Despesa" : "Receita"}: ${
                    info.event.title
                } - R$ ${props.valor?.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}`;
            ...
            <Card className="p-6">
                <div className="space-y-4">
                    <div className="flex justify-between items-center">
                        <h2 className="text-2xl font-bold text-gray-900">Calendário Financeiro</h2>
