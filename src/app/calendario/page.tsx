        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Acompanhe as despesas e receitas pendentes
            </p>
          </div>
        </div>
      </header>
      ...
      <main className="p-6 space-y-6">
        ...
        <div className="flex gap-4">
          ...
          <div className="w-2/3 flex flex-col gap-3">
            <Card>
              <CardHeader>
                <CardTitle>Filtros de Despesas Pendentes</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Select value={filtroStatus} onValueChange={setFiltroStatus}>
                    ...
                    <SelectContent>
                      <SelectItem value="todas">Todas Pendentes</SelectItem>
                      <SelectItem value="vencidas">Vencidas</SelectItem>
                      <SelectItem value="proximas">
                        Próximas (7 dias)
                      </SelectItem>
                      <SelectItem value="futuras">
                        Futuras (+ de 7 dias)
                      </SelectItem>
                    </SelectContent>
                  </Select>
                      ...
                      <div className="md:text-right flex md:flex-col items-center md:items-end gap-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {item.diasRestantes > 0
                            ...
                            : item.diasRestantes === 0
                            ? "Hoje"
                            : `${Math.abs(item.diasRestantes)} dias atraso`}
                        </p>
                      </div>
                    </div>
                  ))}
