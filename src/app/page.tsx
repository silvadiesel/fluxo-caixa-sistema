                ...
                {atividades.map((atividade) => (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <div
                        className={`md:p-2 p-1 rounded-full ${
                      ...
                      >
                        {atividade.tipo === "entrada" ? (
                          <ArrowUpRight className="md:h-4 md:w-4 h-3 w-3" />
                        ) : (
                          <ArrowDownRight className="md:h-4 md:w-4 h-3 w-3" />
                        )}
                      </div>
                      <div>
                        <p className="font-medium text-sm md:text-lg text-foreground">
                          {atividade.descricao}
                        </p>
                        <p className="text-sm text-muted-foreground">
                          {formatDateBR(atividade.data)} • {atividade.categoria}
                        </p>
                      </div>
                    </div>
                    <div className="text-right">
                      <p
                        className={`font-semibold text-sm flex flex-nowrap md:text-lg ${
                          atividade.tipo === "entrada"
                            ? "text-green-600"
                            : "text-red-600"
                        }`}
                      ...
                      <Badge
                        variant={
                          atividade.tipo === "entrada" ? "default" : "secondary"
                        }
                        className="text-xs"
                      >
                        {atividade.tipo === "entrada" ? "Receita" : "Despesa"}
                      </Badge>
                    </div>
                  </div>
                ))}
